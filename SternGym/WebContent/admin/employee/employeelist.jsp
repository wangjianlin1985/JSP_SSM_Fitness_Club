        ...
        table.on('tool(demo)', function (obj) {
            ...
            if (obj.event === 'detail') {
                ...
                layer.confirm('真的删除该员工么', function (index) {
                    $.ajax({
                        url: "<%=request.getContextPath()%>/admin/employee/del.html",
                        type: "post",
                        data: "eid=" + data.eid,
                ...
                layer.open({
                    ...
                    title:"修改员工信息" ,
                    area:['500px','500px'],
                    content:"<%=request.getContextPath()%>/admin/employee/goaddorupdate.html?eid="+data.eid
                });
            }
        });
        table.render({
            id: "employeetable",
            elem: "#test",
            url: '<%=request.getContextPath()%>/admin/employeelist.html',
            cols: [
                [
                    {field: 'eid', width:100, sort: true, fixed: true, title: '员工工号'},
                    {field: 'ename', width: 90, title: '员工姓名'},
                    {field: 'egender', width: 90, sort: true, title: '性别', templet: '#genderParse'},
                    {field: 'ephone', width: 160, title: '手机号'},
                    {field: 'epostId', width: 90, title: '员工职务', templet: '#postParse'},
                    {field: 'eadd', width: 200, title: '员工住址'},
...
//                        }
        ...
        $("#addBnt").on('click',function () {
            layer.open({
                ...
                title:"添加员工" ,
                area:['500px','500px'],
                content:"<%=request.getContextPath()%>/admin/employee/goaddorupdate.html"
            });
        });
    });
